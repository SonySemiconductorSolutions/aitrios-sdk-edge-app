...
If you think that you have identified a security vulnerability in the codes, please send us your report with as much context as possible via [our contact form](https://support.aitrios.sony-semicon.com/hc/en-us/requests/new).
...
Bear in mind that when you contribute a new feature, the maintenance burden is transferred to the EdgeApp team. This means that the benefit of the contribution must be compared against the cost of maintaining the feature.

For more details,please refer to the [Design Document](docs/design_document.md) and [Coding guidelines](docs/Coding_guidelines.md).
