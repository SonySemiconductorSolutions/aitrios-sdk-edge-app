...
inline const BoundingBox (&EnumValuesBoundingBox())[2] {
  static const BoundingBox values[] = {BoundingBox_NONE,
                                       BoundingBox_BoundingBox2d};
  return values;
}

inline const char *const *EnumNamesBoundingBox() {
  static const char *const names[3] = {"NONE", "BoundingBox2d", nullptr};
  return names;
}

inline const char *EnumNameBoundingBox(BoundingBox e) {
  if (::flatbuffers::IsOutRange(e, BoundingBox_NONE, BoundingBox_BoundingBox2d))
    return "";
...
template <>
struct BoundingBoxTraits<SmartCamera::BoundingBox2d> {
  static const BoundingBox enum_value = BoundingBox_BoundingBox2d;
};

bool VerifyBoundingBox(::flatbuffers::Verifier &verifier, const void *obj,
                       BoundingBox type);
bool VerifyBoundingBoxVector(
...
struct BoundingBox2d FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int32_t left() const { return GetField<int32_t>(VT_LEFT, 0); }
  int32_t top() const { return GetField<int32_t>(VT_TOP, 0); }
  int32_t right() const { return GetField<int32_t>(VT_RIGHT, 0); }
  int32_t bottom() const { return GetField<int32_t>(VT_BOTTOM, 0); }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int32_t>(verifier, VT_BOTTOM, 4) && verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<BoundingBox2d> CreateBoundingBox2d(
    ::flatbuffers::FlatBufferBuilder &_fbb, int32_t left = 0, int32_t top = 0,
    int32_t right = 0, int32_t bottom = 0) {
...
struct GeneralObject FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  SmartCamera::BoundingBox bounding_box_type() const {
    return static_cast<SmartCamera::BoundingBox>(
        GetField<uint8_t>(VT_BOUNDING_BOX_TYPE, 0));
  }
  const void *bounding_box() const {
    return GetPointer<const void *>(VT_BOUNDING_BOX);
  }
  template <typename T>
  const T *bounding_box_as() const;
  const SmartCamera::BoundingBox2d *bounding_box_as_BoundingBox2d() const {
    return bounding_box_type() == SmartCamera::BoundingBox_BoundingBox2d
               ? static_cast<const SmartCamera::BoundingBox2d *>(bounding_box())
               : nullptr;
  }
...
template <>
inline const SmartCamera::BoundingBox2d *
GeneralObject::bounding_box_as<SmartCamera::BoundingBox2d>() const {
...
struct GeneralObjectBuilder {
  ...
  void add_bounding_box_type(SmartCamera::BoundingBox bounding_box_type) {
    fbb_.AddElement<uint8_t>(GeneralObject::VT_BOUNDING_BOX_TYPE,
                             static_cast<uint8_t>(bounding_box_type), 0);
  }
...
inline ::flatbuffers::Offset<GeneralObject> CreateGeneralObject(
    ...
    ::flatbuffers::Offset<void> bounding_box = 0, float score = 0.0f) {
...
struct ObjectDetectionData FLATBUFFERS_FINAL_CLASS
    : private ::flatbuffers::Table {
  typedef ObjectDetectionDataBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_OBJECT_DETECTION_LIST = 4
  };
  const ::flatbuffers::Vector<::flatbuffers::Offset<SmartCamera::GeneralObject>>
      *object_detection_list() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<SmartCamera::GeneralObject>> *>(
        VT_OBJECT_DETECTION_LIST);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct ObjectDetectionDataBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_object_detection_list(
      ::flatbuffers::Offset<::flatbuffers::Vector<
          ::flatbuffers::Offset<SmartCamera::GeneralObject>>>
          object_detection_list) {
    fbb_.AddOffset(ObjectDetectionData::VT_OBJECT_DETECTION_LIST,
                   object_detection_list);
  }
...
inline ::flatbuffers::Offset<ObjectDetectionData> CreateObjectDetectionData(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<
        ::flatbuffers::Offset<SmartCamera::GeneralObject>>>
        object_detection_list = 0) {
  ObjectDetectionDataBuilder builder_(_fbb);
  builder_.add_object_detection_list(object_detection_list);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<ObjectDetectionData>
CreateObjectDetectionDataDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<::flatbuffers::Offset<SmartCamera::GeneralObject>>
        *object_detection_list = nullptr) {
  auto object_detection_list__ =
      object_detection_list
          ? _fbb.CreateVector<
                ::flatbuffers::Offset<SmartCamera::GeneralObject>>(
                *object_detection_list)
          : 0;
  return SmartCamera::CreateObjectDetectionData(_fbb, object_detection_list__);
}

struct ObjectDetectionTop FLATBUFFERS_FINAL_CLASS
    : private ::flatbuffers::Table {
...
struct ObjectDetectionTopBuilder {
  ...
  ::flatbuffers::uoffset_t start_;
  void add_perception(
      ::flatbuffers::Offset<SmartCamera::ObjectDetectionData> perception) {
...
inline bool VerifyBoundingBox(::flatbuffers::Verifier &verifier,
                              const void *obj, BoundingBox type) {
  switch (type) {
...
inline bool VerifyBoundingBoxVector(
    ::flatbuffers::Verifier &verifier,
    const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values,
    const ::flatbuffers::Vector<uint8_t> *types) {
  ...
  for (::flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyBoundingBox(verifier, values->Get(i),
                           types->GetEnum<BoundingBox>(i))) {
      return false;
    }
  }
  return true;
...
inline const SmartCamera::ObjectDetectionTop *GetObjectDetectionTop(
    const void *buf) {
  return ::flatbuffers::GetRoot<SmartCamera::ObjectDetectionTop>(buf);
}

inline const SmartCamera::ObjectDetectionTop *GetSizePrefixedObjectDetectionTop(
    const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SmartCamera::ObjectDetectionTop>(
      buf);
}

inline bool VerifyObjectDetectionTopBuffer(::flatbuffers::Verifier &verifier) {
...
inline bool VerifySizePrefixedObjectDetectionTopBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SmartCamera::ObjectDetectionTop>(
      nullptr);
}
