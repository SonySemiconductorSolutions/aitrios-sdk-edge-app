...
/**
 * License Plate Detection post processing function
 *
 * @param tensors Vector of output tensors from LPD model.
 * @param param Analysis parameters for license plate detection.
 * @return DataProcessorResultCode
 */
DataProcessorResultCode LPDDataProcessorAnalyze(
    const std::vector<EdgeAppCore::Tensor> &tensors,
...
/**
 * License Plate Recognition post processing function
 *
 * @param tensors Vector of output tensors from LPR model.
 * @param out_data Pointer of recognized license plate data.
 * @param out_size Pointer of recognized license plate data size.
 * @return DataProcessorResultCode
 */
...
// Expose LP_CATEGORIES_OCR for OCR character decoding
