...
/*
 * Modifications by Sony Semiconductor Solutions Corp.
 * - Modified the load_by_name function to temporarily adapt load_by_name in the "wasi_nn" module
 * - Based on WAMR 2.3.0
 * - Original file: https://github.com/bytecodealliance/wasm-micro-runtime/blob/WAMR-2.3.0/core/iwasm/libraries/wasi-nn/include/wasi_nn.h
 * - Note: This modification is temporary and will be updated to align with the official specification in the future.
 */
