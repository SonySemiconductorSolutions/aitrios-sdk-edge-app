...
#ifndef MOCKS_MOCK_DATA_PROCESSOR_API_HPP
...
void resetDataProcessorConfigureCalled();

int wasDataProcessorAnalyzeCalled();
void setDataProcessorAnalyzeFail();
void resetDataProcessorAnalyzeSuccess();
void resetDataProcessorAnalyzeCalled();

int wasDataProcessorJsonFormatCalled();
void setDataProcessorJsonFormatFail();
void resetDataProcessorJsonFormatSuccess();
void resetDataProcessorJsonFormatCalled();

int wasDataProcessorGetDataTypeCalled();

#endif /* MOCKS_MOCK_DATA_PROCESSOR_API_HPP */
