...
typedef void (*EVP_CONFIGURATION_CALLBACK)(const char *topic,
                                           const void *config, size_t configlen,
                                           void *userData);
 ...
 * @return @ref EVP_OK Success.
 */
EVP_RESULT EVP_setRpcCallback(struct EVP_client *h, EVP_RPC_REQUEST_CALLBACK cb,
                              void *userData);
 ...
 */
typedef void (*EVP_STREAM_READ_CALLBACK)(EVP_STREAM_PEER_ID id, const void *buf,
